...
|---|---|---|---|---|
| The Danger of a Single Story | https://www.youtube.com/watch?v=D9Ihs241zeg | TED | Manual | ~20 mins |
| Your Body Language May Shape Who You Are | https://www.youtube.com/watch?v=Ks-_Mh1QhMc | TED | Manual | ~20 mins |
| The History of Our World in 18 Minutes | https://www.youtube.com/watch?v=yqc9zX04DXs | TED | Manual | ~20 mins |
| The Power of Vulnerability | https://www.youtube.com/watch?v=X4Qm9cGRub0 | Brené Brown / TEDx | Auto | ~20 mins |
...
Each benchmark video has a reference summary. The system generates its own summary, which is then evaluated for qualities such as factual consistency and coverage using the evaluation pipeline.
